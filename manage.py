...
def initdb():
    ...
    RSS_source1 = SourceType_RSS(source=5, format=1, url="feed://www.foodandwine.com/feeds/latest_articles")
    RSS_source2 = SourceType_RSS(source=6, format=1, url="www.health.com/health/food-recipes/feed")
    RSS_source1 = SourceType_RSS(source=7, format=1, url="feed://www.womenshealthandfitness.com.au/component/obrss/diet-nutrition")
    RSS_source2 = SourceType_RSS(source=8, format=1, url="feed://feeds.bbci.co.uk/news/rss.xml")
    RSS_source1 = SourceType_RSS(source=9, format=1, url="http://rss.cnn.com/rss/cnn_topstories.rss")
    RSS_source2 = SourceType_RSS(source=10, format=1, url="https://www.sciencedaily.com/rss/top.xml")
    RSS_source1 = SourceType_RSS(source=11, format=1, url="feed://www.livescience.com/home/feed/site.xml")
    RSS_source2 = SourceType_RSS(source=12, format=1, url="http://feeds.feedburner.com/RandomFactsBlog?format=xml")
    ...
    reminder_source = SourceType_Reminder(source=4,message='Keep it up. You are awesome!')
    reminder_source = SourceType_Reminder(source=13,message="I totally understand how batteries feel because Im rarely ever included in things either.")
    reminder_source = SourceType_Reminder(source=14,message='You kill vegetarian vampires with a steak to the heart.')
