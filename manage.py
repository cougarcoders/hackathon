...
def initdb():
    ...
    RSS_source2 = SourceType_RSS(source=2, format=2, url="http://www.wired.com/category/design/feed/")
    ...
    queue_contents = Queue_Contents(queue_id = 1, content_id = 1)
    db.session.add(queue_contents)
    queue_contents = Queue_Contents(queue_id = 1, content_id = 2)
    db.session.add(queue_contents)
    queue_contents = Queue_Contents(queue_id = 1, content_id = 3)
    db.session.add(queue_contents)
    queue_contents = Queue_Contents(queue_id = 2, content_id = 1)
    db.session.add(queue_contents)
    queue_contents = Queue_Contents(queue_id = 2, content_id = 3)
    db.session.add(queue_contents)
    queue_contents = Queue_Contents(queue_id = 3, content_id = 1)
    db.session.add(queue_contents)
    queue_contents = Queue_Contents(queue_id = 3, content_id = 2)
    db.session.add(queue_contents)
    queue_contents = Queue_Contents(queue_id = 3, content_id = 3)
    db.session.add(queue_contents)
    queue_contents = Queue_Contents(queue_id = 4, content_id = 3)
    db.session.add(queue_contents)
